    ...
    : QWidget(parent)
{
    ...
    connect(addBtn, &QPushButton::clicked, this, &ConnectionWidget::addDatabaseRequested);
    
    tree = new QTreeWidget(this);
    tree->setObjectName(QLatin1String("tree"));
    tree->setHeaderLabels(QStringList(tr("Databases")));
...
void ConnectionWidget::refresh()
{
    ...
    for (int i = 0; i < connectionNames.count(); ++i) {
        ...
        root->setToolTip(0, db.databaseName());
